...
// Functions and structs used to render the 3D enviroment such as cars or the 
// highway

#include "render.h"

// Render highway model for simpleHighway simulation
...
// Render 3D point cloud (pcl::PointXYZ) using a user-specified color
...
// Render 3D point cloud with intensity (pcl::PointXYZI) using either color defined by intensity or a user-specified color
...
// Draw 3D wire frame box (cartesian representation) with filled transparent color 
...
// Draw 3D wire frame box (quaternion representation) with filled transparent color 
